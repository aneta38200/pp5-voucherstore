...
import pl.ahendzel.voucherstore.productcatalog.Product;
import pl.ahendzel.voucherstore.productcatalog.ProductCatalogFacade;
import pl.ahendzel.voucherstore.sales.basket.Basket;
import pl.ahendzel.voucherstore.sales.basket.InMemoryBasketStorage;
import pl.ahendzel.voucherstore.sales.offer.Offer;
import pl.ahendzel.voucherstore.sales.offer.OfferMaker;
import pl.ahendzel.voucherstore.sales.ordering.ClientData;
import pl.ahendzel.voucherstore.sales.ordering.OfferChangedException;
...
import pl.ahendzel.voucherstore.sales.payment.PaymentDetails;
import pl.ahendzel.voucherstore.sales.payment.PaymentGateway;
import pl.ahendzel.voucherstore.sales.payment.PaymentUpdateStatusRequest;
import pl.ahendzel.voucherstore.sales.payment.PaymentVerificationException;
